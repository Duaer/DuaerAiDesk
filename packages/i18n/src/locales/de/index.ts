...
export const de = {
  "app": {
    ...
    "starting": "DuaerAiDesk wird gestartet…",
    "loadingView": "Ansicht wird geladen…",
    "uiCrashed": "Mit der Schnittstelle ist ein Fehler aufgetreten"
  },
  "startup": {
    "slowTitle": "Startet noch…",
    "slowBody": "DuaerAiDesk braucht länger als sonst, um Ihren lokalen Dienst zu erreichen. Der Start kann noch von selbst abschließen — Sie können warten oder zuerst die Protokolle sichern.",
    "stalledTitle": "DuaerAiDesk konnte den Start nicht abschließen",
  ...
  "tray": {
    ...
    "open": "Öffnen Sie DuaerAiDesk",
    "quit": "Beenden Sie DuaerAiDesk",
    "askTitle": "Lassen Sie DuaerAiDesk im Hintergrund laufen?",
    "askBody": "Wenn Sie das Fenster schließen, kann DuaerAiDesk in der Taskleiste weiterlaufen, sodass nichts verloren geht. Sie können dies jederzeit in den Einstellungen ändern.",
    "closeToTray": "In der Taskleiste",
    "confirmQuitTitle": "DuaerAiDesk beenden?",
  ...
  "chat": {
    ...
    "placeholder": "Bitten Sie DuaerAiDesk um Hilfe bei allem",
...
"slashCommandSourceUnavailable": "Befehlsliste nicht verfügbar, es wurde nichts gesendet. Bitte erneut versuchen.",
    ...
    "copy": "Kopieren",
    "choiceOptions": "Antwortvorschläge",
    "copied": "Kopiert",
  ...
  "settings": {
    ...
    "judgmentModel": "Prüfmodell",
    "judgmentModelUnset": "Nicht konfiguriert",
    "judgmentModelUnavailable": "Derzeit nicht verfügbar",
    ...
    "setJudgmentModel": "Als Prüfmodell festlegen",
    "judgmentModelSelected": "Ausgewähltes Prüfmodell",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Wird in DuaerAiDesk gespeichert und von der Laufzeitumgebung verwendet. Das Plugin erhält ihn niemals.",
    ...
    "deploy": {
      ...
      "pages": "GitHub Pages",
      "pagesNote": "Schlüssel bleiben auf diesem Rechner. Nach dem Speichern werden sie nicht wieder angezeigt und nicht ins Repository geschrieben. GitHub Pages nutzt das bereits angemeldete gh.",
      "cloudflare": "Cloudflare",
      "cloudflareHint": "Cloudflare erscheint in der Zuteilung, wenn Token und Account ID gespeichert sind.",
      "token": "API Token",
      "account": "Account ID",
      "aliyun": "Alibaba Cloud",
      "aliyunHint": "Alibaba Cloud erscheint, wenn AccessKey ID und Secret gespeichert sind.",
      "accessKeyId": "AccessKey ID",
      "accessKeySecret": "AccessKey Secret",
      "aws": "AWS",
      "awsHint": "AWS erscheint, wenn beide Schlüssel gespeichert sind. Die Region ist optional.",
      ...
      "keep": "Gespeichert. Leer lassen behält den Wert.",
      "saved": "Gespeichert",
  ...
  "project": {
    ...
    "createBackgroundLabel": "Hintergrund",
    "createBackgroundPlaceholder": "Ein, zwei Sätze: für wen, und welches Problem…",
  ...
  "scheduled": {
    "description": "Wiederkehrende Agent-Aufgaben ausführen, solange DuaerAiDesk geöffnet ist.",
    ...
    "time": "Uhrzeit",
    "weekday": "Wochentag",
    "localTimeHint": "Verwendet die lokale Zeitzone. DuaerAiDesk muss geöffnet bleiben; verpasste Ausführungen werden übersprungen.",
  ...
  "panel": {
    ...
    "requirements": {
      "empty": "Öffnen Sie zuerst ein Projekt in der Seitenleiste.",
      "open": "Anforderungen sammeln",

      "modules": "Module",
      "addModule": "Modul hinzufügen",
      "progress": "Module {{done}}/{{total}} bestätigt",
      "moduleName": "Modulname",
      "moduleDraft": "Entwurf",
      "moduleReady": "Bereit",
      "baseline": "Baseline",
      "background": "Projekthintergrund",
      "backgroundPh": "Worum es in dieser Runde geht",
      "global": "Globale Anforderungen",
      "style": "Seitenstil",
      "styleHint": "Schreibt der UI-Designer nach der Architektur-Sperre. Die Anforderungsbestätigung prüft das nicht.",
      "layout": "Layout",
      "layoutHint": "Schreibt der UI-Designer nach der Architektur-Sperre. Die Anforderungsbestätigung prüft das nicht.",
      "moduleBaseline": "Die gemeinsame Baseline prüft die globale Karte. Stil und Layout schreibt der UI-Designer nach der Architektur. Eine eigene Anforderung hier muss trotzdem prüfbar sein.",
      "lockHintNeedModule": "Ziel und prüfbare Abnahme dieses Moduls schreiben. Eine eigene Anforderung muss trotzdem prüfbar sein.",
      "lockHint": "Bestätigen bleibt aus, bis die lokalen Prüfungen bestehen.",
      "lockHintNeed": "Füllen Sie ein konkretes Ziel, eine prüfbare Abnahme und die acht Baseline-Felder aus.",
      "lockHintReady": "Prüfung bestanden. Dieses Modul kann bestätigt werden.",
      "lockHintChecking": "Modul wird geprüft…",
      "lockHintFailed": "Prüfung nicht bestanden.",
      "lockHintNeedValidate": "Warten auf die Anforderungsprüfung.",
      "autoHandle": "Automatisch korrigieren",
      "autoHandling": "Wird korrigiert…",
      "chatValidateStart": "Prüfe die Bestätigungskarte dieses Moduls…",
      "chatValidatePassed": "Prüfung bestanden: {{summary}}",
      "chatValidateFailed": "Prüfung nicht bestanden: {{summary}}",
      "chatNeedAutoHandle": "Die Bestätigungskarte ist noch unvollständig. Wähle „Automatisch korrigieren“ im Chat oder ergänze weiter im Dialog.",
      "chatAutoHandleStart": "Karte wird automatisch korrigiert (prüfbare Abnahme aus den Prüfproblemen)…",
      "chatValidateFixed": "Automatisch korrigiert und Prüfung bestanden: {{summary}}. Du kannst bestätigen.",
      "chatFixStillFailed": "Nach Auto-Korrektur weiter fehlgeschlagen{{note}}. Erneut versuchen oder Karte bearbeiten.",
      "chatAutoFixFail": "Auto-Korrektur fehlgeschlagen: {{msg}}",
      "chatAutoFixBusy": "Warte, bis die aktuelle Antwort fertig ist, und versuche Auto-Korrektur erneut.",
      "lockHintModuleDone": "Dieses Modul ist bestätigt. Wechseln Sie die Registerkarte für die übrigen.",
      "lockHintLocked": "Alle Module sind bestätigt.",
      "reqAdd": "Eintrag hinzufügen",
      "reqRemove": "Eintrag entfernen",
      "allConfirmed": "Alle Module bestätigt",
      "moduleLabel": "Modul {{n}}",
      "goal": "Ziel",
      "out": "Nicht im Umfang",
      "accept": "Abnahme",
      "acceptHint": "Prüfbares Ergebnis: wo öffnen, was sichtbar ist, welcher Befehl besteht.",
      "assume": "Annahmen",
      "placeholder": "Noch nicht bestätigt",
      "confirm": "Confirm architecture — ready to dispatch",
      "confirmed": "Bestätigt",
      "locked": "Dieses Modul ist gesperrt. Fügen Sie ein Modul hinzu, um weiterzusammeln.",
      "needFields": "Ziel und Abnahme sind vor der Bestätigung nötig.",
      "device": "Browser und Geräte",
      "deviceHint": "Mindestens zwei Browser oder Geräte, plus Nachweis und Fallback.",
      "devicePh": "Beispiel: die letzten zwei Chrome-Versionen, Mobile Safari",
      "paths": "Kritische Pfade",
      "pathsHint": "Hauptpfade, die die Integration abdecken muss.",
      "pathsPh": "Beispiel: Anmeldung → Start → Absenden",
      "exceptions": "Ausnahmen",
      "exceptionsHint": "Leer, Fehler, Rechte, Timeout und Wiederholen abdecken.",
      "exceptionsPh": "Beispiel: leere Liste; Absenden kann wiederholen; 403",
      "apiContract": "API-Vertrag",
      "apiContractHint": "OpenAPI- oder Typpfad. Ohne HTTP-API das sagen.",
      "apiContractPh": "Beispiel: openapi/openapi.yaml oder keine HTTP-API",
      "envChecklist": "Umgebung",
      "envChecklistHint": "DNS, TLS, CORS, Auth und Dritte müssen vor dem Bau bestehen.",
      "envChecklistPh": "Beispiel: DNS, TLS, CORS und Auth bestehen",
      "dataPrecheck": "Datenvorprüfung",
      "dataPrecheckHint": "Feldzuordnung und Fehlerliste beim Import. Ohne Import das sagen.",
      "dataPrecheckPh": "Beispiel: mapping.csv oder kein Import",
      "externalDeps": "Externe Abhängigkeiten",
      "externalDepsHint": "Blocker, SLA, Mock und ein Parallelpfad. Ohne das sagen.",
      "externalDepsPh": "Beispiel: Anbieter-API oder keine externe Abhängigkeit",
      "perfBudget": "Leistungsbudget",
      "perfBudgetHint": "LCP, INP, Paket, lange Listen und langsames Netz. Ohne Seite das sagen.",
      "perfBudgetPh": "Beispiel: LCP 2,5s oder keine Seitenanforderung",
      "issue": {
        "goalShort": "Ziel ist zu kurz.",
        "acceptanceShort": "Abnahme ist zu kurz.",
        "acceptanceVague": "Abnahme ist zu vage. Schreiben Sie, was sich öffnet, was sichtbar ist und welcher Befehl besteht.",
        "acceptanceCheck": "Abnahme muss objektiv prüfbar sein.",
        "device": "Gerätematrix unvollständig: {{missing}}",
        "paths": "Kritische Pfade sind nötig.",
        "exceptions": "Ausnahmen unvollständig: {{missing}}",
        "exceptionsCode": "Ausnahmen brauchen einen Fehlercode oder HTTP-Status, wenn ein API-Vertrag genannt ist.",
        "api": "API-Vertrag ist nötig, oder schreiben Sie, dass es keine HTTP-API gibt.",
        "env": "Umgebungsprüfung unvollständig: {{missing}}",
        "data": "Datenvorprüfung unvollständig: {{missing}}",
      ...
      "gap": {
        ...
        "evidence": "Screenshot oder Cloud-Nachweis",
        "fallback": "ein Fallback",
        "empty": "leer",
        "failure": "Fehler",
        ...
        "cors": "CORS",
        "auth": "Auth",
        "thirdParty": "Dritte erreichbar",
        "probeFailed": "eine fehlgeschlagene Prüfung",
        "probePass": "ein bestandenes Ergebnis",
        "mapping": "Feldzuordnung",
        "failureList": "Import-Fehlerliste",
        "exportable": "ein Export",
        "blocker": "ein Blocker",
        "sla": "SLA",
        "mock": "ein Mock",
        "parallel": "ein Parallelpfad",
        "lcp": "LCP",
        "inp": "INP",
        "bundle": "Paketgröße",
        "longList": "virtualisierte lange Listen",
        "weakNet": "schwaches Netz",
        "largeData": "ein Großdatenlauf"
      },
      "stage": {
        "drafting": "Entwurf",
        ...
        "building": "Umsetzung",
        "delivered": "Geliefert",
        "revising": "Nachbesserung"
      }
    },
    "architecture": {
      "title": "System architecture",
      "mountEmpty": "The architecture diagram appears here. Design it in chat, or regenerate.",
      "open": "Architektur entwerfen",
      "needModules": "Bestätigen Sie jedes Modul, bevor Sie die Architektur entwerfen.",
      "hint": "Bestätigte Module werden zu Blöcken. Danach kann verteilt werden.",
      "summary": "Überblick",
      "summaryPh": "Wie die bestätigten Module zusammenpassen",
      "components": "Komponenten",
      "add": "Komponente hinzufügen",
      "name": "Name",
      "responsibility": "Aufgabe",
      "confirm": "Architektur bestätigen",
      "confirmed": "Architektur bestätigt",
      "locked": "Architektur ist gesperrt. Als Nächstes kommt die Verteilung.",
      "needFields": "Überblick und eine benannte Komponente sind nötig.",
      ...
      "enterDesignExisting": "Vorhandene Funktionen sind bestätigt. Als Nächstes die aktuelle Systemarchitektur im Chat festhalten — Option wählen oder antworten.",
      "kickoffPromptExisting": "Vorhandene Funktionen sind bestätigt. Halten Sie die aktuelle Systemarchitektur anhand der Karten fest: eine zentrale Architekturfrage, im JSON ein Archify-IR (diagram_type architecture, components mit type/label, connections) plus summary der heute vorhandenen Komponenten, und 2–5 kurze Optionen. Nicht verteilen.",
    ...
    "dispatch": {
      "open": "Zuteilung",
      "needArchitecture": "Bestätigen Sie die Architektur vor der Zuteilung.",
      "workers": "Digitale Mitarbeitende",
      "recommend": "Empfohlen: {{n}} (parallele Breite)",
      "start": "Aufgaben starten",
      "roleImplement": "Umsetzen",
      "roleVerify": "Prüfen",
      "roleDeploy": "Liefern",
      "splitNote": "Architektur bestätigt. Aufgaben werden aufgeteilt.",
      "splitting": "Aufgaben werden im Chat aufgeteilt. Die Begründung steht im Gespräch.",
      "decomposeTitle": "Aufgabenzerlegung",
      "redecompose": "Neu zerlegen",
      "parallel": "Parallel",
      "workerSerial": "Seriell",
      "workerParallel": "Parallel",
      "host": "Hosting",
      "hostNone": "Nicht veröffentlichen",
      "hostPages": "GitHub Pages",
      "confirmGraph": "Anzahl bestätigen und Dispatch-Grafik zeichnen",
      "graphBuilding": "Dispatch-Grafik wird gezeichnet…",
      "graphReady": "Dispatch-Grafik fertig",
      "graphTitle": "Aufgaben-Ausführungspfad",
      "graphFail": "Dispatch-Grafik fehlgeschlagen: {{msg}}",
      ...
      "workerLane": "Mitarbeiter {{id}}",
      "hint": "Die Aufteilung steht im Chat. Nach Prüfung der Liste und Signatur an Subagenten geben."
    },
    "baseline": {
      "mark": "Umfang- und Abnahme-Baseline (FDE-01)",
      "hint": "Ohne Unterschrift kein Start. Eine Änderung braucht einen Grund und eine neue Unterschrift.",
      "signer": "Unterzeichner",
      "signerPh": "Name oder Rolle",
      "sign": "Baseline unterschreiben",
      "change": "Änderung öffnen",
      "changeReason": "Änderungsgrund",
      "changePh": "Warum Umfang oder Abnahme sich ändert",
      "needSign": "Unterschreiben Sie die Baseline, bevor die Zuteilung startet.",
      "signedLine": "Unterschrieben · {{signer}} · {{at}}"
    },
    "pluginView": {
...
"importConfirm": "Importierte Erweiterungen laufen im Agentenprozess mit denselben Rechten wie die Tools des Agenten. Deklarierte Skills können dem Agenten Anweisungen hinzufügen, und deklarierte Abhängigkeiten werden mit npm installiert (Installationsskripte deaktiviert). Fortfahren?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Fügt die Anbieter, die dieses Plugin definiert, zur Anbieterliste in den Einstellungen hinzu. Das Plugin liefert den Endpunkt und die Modelle; Ihr API-Schlüssel bleibt in DuaerAiDesk.",
      "desktop.control": "Erlaubt den Aufruf des geprüften DuaerAiDesk-Katalogs; destruktive Vorgänge benötigen weiterhin confirm=true, und das MCP-Bearer-Token wird nicht offengelegt.",
      ...
      "keyboard.globalShortcut": "Registriert systemweite Tastaturkürzel, die die eigenen Befehle dieses Plugins auslösen, während DuaerAiDesk nicht fokussiert ist.",
  ...
  "extensions": {
    ...
    "subagents": {
      ...
      "presetCoderDesc": "Schreibt den Code für eine zugewiesene Aufgabe, bis die Abnahme stimmt.",
      "presetUiDesignerName": "UI-Designer",
      "presetUiDesignerDesc": "Schreibt Stil und Layout der Seite nach der Architektur. Ändert keine Dateien und teilt keine Aufgaben.",
      "presetJudgeName": "Duaer Gutachter",
      "presetJudgeDesc": "Bewertet Anforderung, Umfang oder ob die Abnahme konkret genug ist.",
      ...
      "judgmentModelHint": "Nur das als Prüfmodell markierte Modell.",
      "judgmentModelEmpty": "Noch kein Prüfmodell. Markieren Sie eines als Prüfmodell.",
      ...
      "builtinModelNote": "Die Anweisungen bleiben wie ausgeliefert. Hier ändert sich nur das Modell.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Diese DuaerAiDesk-Version ist älter als Ihre lokalen Daten (Datenschema {{found}}, diese Version unterstützt {{supported}}). Installieren Sie die neuere DuaerAiDesk-Version, die diese Daten zuletzt geöffnet hat, oder eine spätere.",
    "archMismatch":
