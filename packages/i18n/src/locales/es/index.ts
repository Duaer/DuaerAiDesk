...
export const es = {
  "app": {
    ...
    "starting": "Iniciando DuaerAiDesk…",
    "loadingView": "Cargando vista…",
    "uiCrashed": "Algo salió mal con la interfaz"
  },
  "startup": {
    "slowTitle": "Aún iniciando…",
    "slowBody": "DuaerAiDesk está tardando más de lo habitual en alcanzar tu servicio local. Puede que aún termine por sí solo — puedes esperar o recoger los registros primero.",
    "stalledTitle": "DuaerAiDesk no pudo terminar de iniciarse",
  ...
  "tray": {
    ...
    "pinned": "Fijadas",
    "viewMore": "Ver más…",
    "open": "Abrir DuaerAiDesk",
    "quit": "Salir de DuaerAiDesk",
    "askTitle": "¿Mantener DuaerAiDesk ejecutándose en segundo plano?",
    "askBody": "Cuando cierra la ventana, DuaerAiDesk puede seguir ejecutándose en la bandeja del sistema para que no se pierda nada. Puedes cambiar esto en cualquier momento en Configuración.",
    "closeToTray": "Cerca de la bandeja",
    "confirmQuitTitle": "¿Salir de DuaerAiDesk?",
  ...
  "chat": {
    ...
    "placeholder": "Pídale ayuda a DuaerAiDesk con cualquier cosa",
...
"slashCommandSourceUnavailable": "La lista de comandos no está disponible, así que no se envió nada. Inténtalo de nuevo.",
    ...
    "copy": "Copiar",
    "choiceOptions": "Respuestas sugeridas",
    "copied": "Copiado",
  ...
  "settings": {
    ...
    "judgmentModel": "Modelo de criterio",
    "judgmentModelUnset": "Sin configurar",
    "judgmentModelUnavailable": "No disponible por ahora",
    ...
    "setJudgmentModel": "Usar como modelo de criterio",
    "judgmentModelSelected": "Modelo de criterio seleccionado",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Se guarda en DuaerAiDesk y lo usa el entorno de ejecución. El complemento nunca lo recibe.",
    ...
    "deploy": {
      "title": "Despliegue",
      "pages": "GitHub Pages",
      "pagesNote": "Las claves se quedan en esta máquina. Tras guardar no se vuelven a mostrar ni se escriben en el repositorio. GitHub Pages usa el gh ya conectado.",
      "cloudflare": "Cloudflare",
      "cloudflareHint": "Cloudflare aparece en el reparto cuando el token y el Account ID están guardados.",
      "token": "API Token",
      "account": "Account ID",
      "aliyun": "Alibaba Cloud",
      "aliyunHint": "Alibaba Cloud aparece cuando el AccessKey ID y el secreto están guardados.",
      "accessKeyId": "AccessKey ID",
      "accessKeySecret": "AccessKey Secret",
      "aws": "AWS",
      "awsHint": "AWS aparece cuando las dos claves están guardadas. La región es opcional.",
      ...
      "configured": "Guardado",
      "missing": "Sin definir",
      "keep": "Guardado. Déjelo vacío para conservarlo.",
      "saved": "Guardado",
  ...
  "project": {
    ...
    "createBackgroundLabel": "Contexto",
    "createBackgroundPlaceholder": "Una o dos frases: para quién es y qué problema resuelve…",
  ...
  "scheduled": {
    "description": "Ejecuta tareas recurrentes mientras DuaerAiDesk está abierto.",
    "edit": "Editar tarea",
    ...
    "localTimeHint": "Usa la zona horaria local. Mantén DuaerAiDesk abierto; las ejecuciones omitidas no se recuperan.",
  ...
  "panel": {
    ...
    "requirements": {
      "empty": "Abra un proyecto desde la barra lateral para recoger requisitos.",
      "open": "Recoger requisitos",

      "modules": "Módulos",
      "addModule": "Añadir módulo",
      "progress": "Módulos {{done}}/{{total}} confirmados",
      "moduleName": "Nombre del módulo",
      "moduleDraft": "Borrador",
      "moduleReady": "Listo",
      "baseline": "Línea base",
      "background": "Contexto del proyecto",
      "backgroundPh": "Qué cambia esta iteración",
      "global": "Requisitos globales",
      "style": "Estilo del sitio",
      "styleHint": "Lo escribe el diseñador de UI tras bloquear la arquitectura. La confirmación de requisitos no lo comprueba.",
      "layout": "Disposición",
      "layoutHint": "Lo escribe el diseñador de UI tras bloquear la arquitectura. La confirmación de requisitos no lo comprueba.",
      "moduleBaseline": "Las bases comunes se comprueban en Requisitos globales. El estilo y la disposición los escribe el diseñador de UI tras la arquitectura. Un requisito propio escrito aquí sigue teniendo que ser comprobable.",
      "lockHintNeedModule": "Escribe el objetivo de este módulo y una aceptación comprobable. Un requisito propio también tiene que ser comprobable.",
      "lockHint": "Confirmar permanece desactivado hasta que pasen las comprobaciones locales.",
      "lockHintNeed": "Complete un objetivo concreto, una aceptación verificable y los ocho campos de línea base.",
      "lockHintReady": "La revisión pasó. Puede confirmar este módulo.",
      "lockHintChecking": "Comprobando este módulo…",
      "lockHintFailed": "La revisión no pasó.",
      "lockHintNeedValidate": "Esperando la revisión de requisitos.",
      "autoHandle": "Corregir",
      "autoHandling": "Corrigiendo…",
      "chatValidateStart": "Comprobando la tarjeta de confirmación de este módulo…",
      "chatValidatePassed": "Revisión aprobada: {{summary}}",
      "chatValidateFailed": "Revisión no aprobada: {{summary}}",
      "chatNeedAutoHandle": "La tarjeta de confirmación aún está incompleta. Elige «Corregir» en el chat o sigue rellenándola en el diálogo.",
      "chatAutoHandleStart": "Corrigiendo automáticamente la tarjeta (aceptación comprobable a partir de los problemas)…",
      "chatValidateFixed": "Corregido y revisión aprobada: {{summary}}. Ya puedes confirmar.",
      "chatFixStillFailed": "Sigue fallando tras la corrección automática{{note}}. Inténtalo de nuevo o edita la tarjeta.",
      "chatAutoFixFail": "Corrección automática fallida: {{msg}}",
      "chatAutoFixBusy": "Espera a que termine la respuesta actual y vuelve a intentar Corregir.",
      "lockHintModuleDone": "Este módulo está confirmado. Cambie de pestaña para confirmar el resto.",
      "lockHintLocked": "Todos los módulos están confirmados.",
      "reqAdd": "Añadir elemento",
      "reqRemove": "Quitar elemento",
      "allConfirmed": "Todos los módulos confirmados",
      "moduleLabel": "Módulo {{n}}",
      "goal": "Objetivo",
      "out": "Fuera de alcance",
      "accept": "Aceptación",
      "acceptHint": "Resultado comprobable: dónde abrir, qué se ve, qué comando pasa.",
      "assume": "Supuestos",
      "placeholder": "Sin confirmar",
      "confirm": "Confirm architecture — ready to dispatch",
      "confirmed": "Confirmado",
      "locked": "Este módulo está bloqueado. Añada otro para seguir recogiendo.",
      "needFields": "Objetivo y aceptación son obligatorios antes de confirmar.",
      "device": "Navegadores y dispositivos",
      "deviceHint": "Al menos dos navegadores o dispositivos, más evidencia y un plan B.",
      "devicePh": "Ejemplo: las dos últimas versiones de Chrome, Safari móvil",
      "paths": "Rutas críticas",
      "pathsHint": "Rutas principales que la integración debe cubrir.",
      "pathsPh": "Ejemplo: entrar → inicio → enviar",
      "exceptions": "Excepciones",
      "exceptionsHint": "Cubrir vacío, fallo, permiso, tiempo de espera y reintento.",
      "exceptionsPh": "Ejemplo: lista vacía; el envío se puede reintentar; 403",
      "apiContract": "Contrato de API",
      "apiContractHint": "Ruta OpenAPI o de tipos. Si no hay API HTTP, decirlo.",
      "apiContractPh": "Ejemplo: openapi/openapi.yaml, o sin API HTTP",
      "envChecklist": "Entorno",
      "envChecklistHint": "DNS, TLS, CORS, auth y terceros deben pasar antes de construir.",
      "envChecklistPh": "Ejemplo: DNS, TLS, CORS y auth pasan",
      "dataPrecheck": "Prechequeo de datos",
      "dataPrecheckHint": "Mapeo de campos y lista de fallos de importación. Si no hay importación, decirlo.",
      "dataPrecheckPh": "Ejemplo: mapping.csv, o sin importación",
      "externalDeps": "Dependencias externas",
      "externalDepsHint": "Bloqueos, SLA, un mock y una ruta paralela. Si no hay, decirlo.",
      "externalDepsPh": "Ejemplo: API del proveedor, o sin dependencia externa",
      "perfBudget": "Presupuesto de rendimiento",
      "perfBudgetHint": "LCP, INP, paquete, listas largas y red lenta. Si no hay página, decirlo.",
      "perfBudgetPh": "Ejemplo: LCP 2,5s, o sin requisito de página",
      "issue": {
        "goalShort": "El objetivo es demasiado corto.",
        "acceptanceShort": "La aceptación es demasiado corta.",
        "acceptanceVague": "La aceptación es vaga. Escriba qué se abre, qué se ve y qué comando pasa.",
        "acceptanceCheck": "La aceptación debe poder comprobarse.",
        "device": "Matriz de dispositivos incompleta: {{missing}}",
        "paths": "Las rutas críticas son obligatorias.",
        "exceptions": "Excepciones incompletas: {{missing}}",
        "exceptionsCode": "Las excepciones deben nombrar un código de error o estado HTTP si hay contrato de API.",
        "api": "El contrato de API es obligatorio, o indique que no hay API HTTP.",
        "env": "Entorno incompleto: {{missing}}",
        "data": "Prechequeo de datos incompleto: {{missing}}",
      ...
      "gap": {
        ...
        "evidence": "captura o evidencia en la nube",
        "fallback": "un plan B",
        "empty": "vacío",
        "failure": "fallo",
        ...
        "cors": "CORS",
        "auth": "auth",
        "thirdParty": "terceros alcanzables",
        "probeFailed": "una prueba fallida",
        "probePass": "un resultado que pasa",
        "mapping": "mapeo de campos",
        "failureList": "lista de fallos de importación",
        "exportable": "una exportación",
        "blocker": "un bloqueo",
        "sla": "SLA",
        "mock": "un mock",
        "parallel": "una ruta paralela",
        "lcp": "LCP",
        "inp": "INP",
        "bundle": "tamaño del paquete",
        "longList": "listas largas virtualizadas",
        "weakNet": "red lenta",
        "largeData": "una prueba con datos grandes"
      },
      "stage": {
        "drafting": "Borrador",
    ...
    "architecture": {
      ...
      "open": "Diseñar arquitectura",
      "needModules": "Confirme cada módulo antes de diseñar la arquitectura.",
      "hint": "Los módulos confirmados se vuelven bloques. Después se puede asignar.",
      "summary": "Resumen",
      "summaryPh": "Cómo encajan los módulos confirmados",
      "components": "Componentes",
      "add": "Añadir componente",
      "name": "Nombre",
      "responsibility": "Responsabilidad",
      "confirm": "Confirmar arquitectura",
      "confirmed": "Arquitectura confirmada",
      "locked": "La arquitectura está bloqueada. Lo siguiente es asignar.",
      "needFields": "Hace falta un resumen y un componente con nombre.",
      ...
      "enterDesignExisting": "Las funciones actuales están confirmadas. Ahora registra la arquitectura actual en el chat — elige una opción o responde.",
      "kickoffPromptExisting": "Las funciones actuales están confirmadas. Registra la arquitectura actual a partir de las tarjetas: una pregunta clave, un IR Archify en JSON (diagram_type architecture, components con type/label, connections) más summary de los componentes que ya existen, y 2–5 opciones cortas. No asignes tareas.",
    ...
    "dispatch": {
      "open": "Asignación",
      "needArchitecture": "Confirme la arquitectura antes de asignar.",
      "workers": "Empleados digitales",
      "recommend": "Recomendado: {{n}} (ancho paralelo)",
      "start": "Empezar tareas",
      "roleImplement": "Implementar",
      "roleVerify": "Verificar",
      "roleDeploy": "Entregar",
      "splitNote": "Arquitectura confirmada. Dividiendo tareas.",
      "splitting": "Dividiendo tareas en el chat. El razonamiento está en la conversación.",
      "decomposeTitle": "Desglose",
      "redecompose": "Volver a desglosar",
      "parallel": "En paralelo",
      "workerSerial": "En serie",
      "workerParallel": "En paralelo",
      "host": "Alojamiento",
      "hostNone": "No publicar",
      "hostPages": "GitHub Pages",
      "confirmGraph": "Confirmar personas y dibujar el grafo",
      "graphBuilding": "Dibujando el grafo…",
      "graphReady": "Grafo listo",
      "graphTitle": "Ruta de ejecución",
      "graphFail": "No se generó el grafo: {{msg}}",
      ...
      "workerLane": "Empleado {{id}}",
      "hint": "El reparto está en el chat. Tras revisar la lista y firmar, entregar a subagentes."
    },
    "baseline": {
      "mark": "Línea base de alcance y aceptación (FDE-01)",
      "hint": "Sin firma no se arranca. Un cambio pide un motivo y una firma nueva.",
      "signer": "Firmante",
      "signerPh": "Nombre o rol",
      "sign": "Firmar la línea base",
      "change": "Abrir cambio",
      "changeReason": "Motivo del cambio",
      "changePh": "Por qué cambia el alcance o la aceptación",
      "needSign": "Firme la línea base antes de asignar.",
      "signedLine": "Firmado · {{signer}} · {{at}}"
    },
    "pluginView": {
...
"importConfirm": "Las extensiones importadas se ejecutan en el proceso del agente con el mismo acceso que sus propias herramientas. Las habilidades declaradas pueden añadir instrucciones al agente y las dependencias declaradas se instalan con npm (scripts de instalación desactivados). ¿Continuar?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Agregue los proveedores que define este complemento a la lista de proveedores de Configuración. El complemento aporta el punto final y los modelos; su clave API permanece en DuaerAiDesk.",
      "desktop.control": "Permite invocar el catálogo de control de DuaerAiDesk revisado; las operaciones destructivas siguen requiriendo confirm=true y el token bearer de MCP no se expone.",
      ...
      "keyboard.globalShortcut": "Registra atajos de teclado del sistema que activan los comandos propios de este complemento mientras DuaerAiDesk no tiene el foco.",
  ...
  "extensions": {
    ...
    "subagents": {
      ...
      "presetCoderName": "Duaer Codificador",
      "presetCoderDesc": "Escribe el código de una tarea asignada hasta cumplir la aceptación.",
      "presetUiDesignerName": "Diseñador UI",
      "presetUiDesignerDesc": "Escribe el estilo y la disposición del sitio tras la arquitectura. No edita archivos ni parte tareas.",
      "presetJudgeName": "Duaer Árbitro",
      "presetJudgeDesc": "Aprueba o rechaza un requisito, un alcance o si la aceptación es comprobable.",
      ...
      "judgmentModelHint": "Solo el modelo marcado para criterio.",
      "judgmentModelEmpty": "Aún no hay modelo de criterio. Márcalo con Usar como modelo de criterio.",
      ...
      "builtinModelNote": "Las instrucciones siguen siendo las de origen. Aquí solo cambia el modelo.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Esta versión de DuaerAiDesk es más antigua que tus datos locales (esquema de datos {{found}}, esta versión admite {{supported}}). Instala la versión más reciente de DuaerAiDesk que abrió estos datos por última vez, o una posterior.",
    "archMismatch":
