...
export const fr = {
  "app": {
    ...
    "starting": "Démarrage de DuaerAiDesk…",
  ...
  "startup": {
    ...
    "slowBody": "DuaerAiDesk met plus de temps que d'habitude à joindre votre service local. Le démarrage peut encore aboutir de lui-même — vous pouvez patienter ou récupérer d'abord les journaux.",
    "stalledTitle": "DuaerAiDesk n'a pas pu terminer son démarrage",
  ...
  "tray": {
    ...
    "pinned": "Épinglées",
    "viewMore": "Voir plus…",
    "open": "Ouvrir DuaerAiDesk",
    "quit": "Quitter DuaerAiDesk",
    "askTitle": "Garder DuaerAiDesk en arrière-plan ?",
    "askBody": "Lorsque vous fermez la fenêtre, DuaerAiDesk peut continuer à s'exécuter dans la barre d'état système afin que rien ne soit perdu. Vous pouvez modifier cela à tout moment dans les paramètres.",
    "closeToTray": "Près du bac",
    "confirmQuitTitle": "Quitter DuaerAiDesk ?",
  ...
  "chat": {
    ...
    "placeholder": "Demandez à DuaerAiDesk de vous aider pour tout",
...
"slashCommandSourceUnavailable": "Liste des commandes indisponible, rien n'a été envoyé. Réessayez.",
    ...
    "copy": "Copier",
    "choiceOptions": "Réponses suggérées",
    "copied": "Copié",
  ...
  "settings": {
    ...
    "judgmentModel": "Modèle de jugement",
    "judgmentModelUnset": "Non configuré",
    "judgmentModelUnavailable": "Indisponible pour le moment",
    ...
    "setJudgmentModel": "Définir comme modèle de jugement",
    "judgmentModelSelected": "Modèle de jugement sélectionné",
...
sklm: {
    ...
    "pluginProviderKeyHint":
      "Stockée dans DuaerAiDesk et utilisée par l'environnement d'exécution. Le plugin ne la reçoit jamais.",
    ...
    "deploy": {
      "title": "Déploiement",
      "pages": "GitHub Pages",
      "pagesNote": "Les clés restent sur cette machine. Après enregistrement elles ne s'affichent plus et ne vont pas dans le dépôt. GitHub Pages utilise le gh déjà connecté.",
      "cloudflare": "Cloudflare",
      "cloudflareHint": "Le choix Cloudflare apparaît après l'enregistrement du jeton et de l'Account ID.",
      "token": "API Token",
      "account": "Account ID",
      "aliyun": "Alibaba Cloud",
      "aliyunHint": "Le choix Alibaba Cloud apparaît après l'enregistrement de l'AccessKey ID et du secret.",
      "accessKeyId": "AccessKey ID",
      "accessKeySecret": "AccessKey Secret",
      "aws": "AWS",
      "awsHint": "Le choix AWS apparaît après l'enregistrement des deux clés. La région est facultative.",
      "awsKeyId": "Access Key ID",
      "awsSecret": "Secret Access Key",
      "region": "Region",
      "save": "Enregistrer",
      "clear": "Effacer",
      "configured": "Enregistré",
      "missing": "Absent",
      "keep": "Enregistré. Laisser vide pour conserver.",
      "saved": "Enregistré",
  ...
  "project": {
    ...
    "createBackgroundLabel": "Contexte",
    "createBackgroundPlaceholder": "Une ou deux phrases : pour qui, et quel problème…",
  ...
  "scheduled": {
    "description": "Exécutez des tâches récurrentes tant que DuaerAiDesk est ouvert.",
    ...
    "localTimeHint": "Utilise le fuseau horaire local. Gardez DuaerAiDesk ouvert ; les exécutions manquées sont ignorées.",
  ...
  "panel": {
    ...
    "requirements": {
      "empty": "Ouvrez un projet dans la barre latérale pour recueillir les exigences.",
      "open": "Recueillir les exigences",

      "modules": "Modules",
      "addModule": "Ajouter un module",
      "progress": "Modules {{done}}/{{total}} confirmés",
      "moduleName": "Nom du module",
      "moduleDraft": "Brouillon",
      "moduleReady": "Prêt",
      "baseline": "Référence",
      "background": "Contexte du projet",
      "backgroundPh": "Ce que cette itération change",
      "global": "Exigences globales",
      "style": "Style du site",
      "styleHint": "Écrit par le designer UI après le verrouillage de l’architecture. La confirmation des exigences ne le vérifie pas.",
      "layout": "Mise en page",
      "layoutHint": "Écrit par le designer UI après le verrouillage de l’architecture. La confirmation des exigences ne le vérifie pas.",
      "moduleBaseline": "Les bases communes se vérifient sur les exigences globales. Le style et la mise en page sont écrits par le designer UI après l’architecture. Une exigence propre écrite ici doit rester vérifiable.",
      "lockHintNeedModule": "Écrire le but de ce module et une acceptation vérifiable. Une exigence propre doit rester vérifiable.",
      "lockHint": "Confirmer reste désactivé tant que les contrôles locaux n'ont pas réussi.",
      "lockHintNeed": "Renseignez un objectif concret, une acceptation vérifiable et les huit champs de référence.",
      "lockHintReady": "La revue est passée. Vous pouvez confirmer ce module.",
      "lockHintChecking": "Vérification de ce module…",
      "lockHintFailed": "La revue n'a pas réussi.",
      "lockHintNeedValidate": "En attente de la revue des exigences.",
      "autoHandle": "Corriger",
      "autoHandling": "Correction…",
      "chatValidateStart": "Vérification de la carte de confirmation de ce module…",
      "chatValidatePassed": "Revue réussie : {{summary}}",
      "chatValidateFailed": "Revue échouée : {{summary}}",
      "chatNeedAutoHandle": "La carte de confirmation est encore incomplète. Choisissez « Corriger » dans le chat, ou continuez dans le dialogue.",
      "chatAutoHandleStart": "Correction auto de la carte (acceptation vérifiable à partir des problèmes)…",
      "chatValidateFixed": "Corrigé et revue réussie : {{summary}}. Vous pouvez confirmer.",
      "chatFixStillFailed": "Échec après correction auto{{note}}. Réessayez ou modifiez la carte.",
      "chatAutoFixFail": "Échec de la correction auto : {{msg}}",
      "chatAutoFixBusy": "Attendez la fin de la réponse en cours, puis réessayez Corriger.",
      "lockHintModuleDone": "Ce module est confirmé. Changez d'onglet pour confirmer les autres.",
      "lockHintLocked": "Tous les modules sont confirmés.",
      "reqAdd": "Ajouter un élément",
      "reqRemove": "Retirer cet élément",
      "allConfirmed": "Tous les modules sont confirmés",
      "moduleLabel": "Module {{n}}",
      "goal": "Objectif",
      "out": "Hors périmètre",
      "accept": "Acceptation",
      "acceptHint": "Résultat vérifiable : où ouvrir, quoi voir, quelle commande réussit.",
      "assume": "Hypothèses",
      "placeholder": "Pas encore confirmé",
      "confirm": "Confirm architecture — ready to dispatch",
      "confirmed": "Confirmé",
      "locked": "Ce module est verrouillé. Ajoutez-en un pour continuer.",
      "needFields": "L'objectif et l'acceptation sont requis avant confirmation.",
      "device": "Navigateurs et appareils",
      "deviceHint": "Au moins deux navigateurs ou appareils, plus une preuve et un repli.",
      "devicePh": "Exemple : deux dernières versions de Chrome, Safari mobile",
      "paths": "Chemins critiques",
      "pathsHint": "Chemins principaux que l'intégration doit couvrir.",
      "pathsPh": "Exemple : connexion → accueil → envoi",
      "exceptions": "Exceptions",
      "exceptionsHint": "Couvrir vide, échec, permission, délai et nouvel essai.",
      "exceptionsPh": "Exemple : liste vide ; l'envoi peut être réessayé ; 403",
      "apiContract": "Contrat d'API",
      "apiContractHint": "Chemin OpenAPI ou de types. S'il n'y a pas d'API HTTP, le dire.",
      "apiContractPh": "Exemple : openapi/openapi.yaml, ou pas d'API HTTP",
      "envChecklist": "Environnement",
      "envChecklistHint": "DNS, TLS, CORS, auth et tiers doivent passer avant de construire.",
      "envChecklistPh": "Exemple : DNS, TLS, CORS et auth passent",
      "dataPrecheck": "Précontrôle des données",
      "dataPrecheckHint": "Correspondance des champs et liste d'échecs d'import. Sinon, le dire.",
      "dataPrecheckPh": "Exemple : mapping.csv, ou pas d'import",
      "externalDeps": "Dépendances externes",
      "externalDepsHint": "Blocages, SLA, un mock et un chemin parallèle. Sinon, le dire.",
      "externalDepsPh": "Exemple : API fournisseur, ou pas de dépendance externe",
      "perfBudget": "Budget de performance",
      "perfBudgetHint": "LCP, INP, paquet, longues listes et réseau lent. Sans page, le dire.",
      "perfBudgetPh": "Exemple : LCP 2,5s, ou pas d'exigence de page",
      "issue": {
        "goalShort": "L'objectif est trop court.",
        "acceptanceShort": "L'acceptation est trop courte.",
        "acceptanceVague": "L'acceptation est trop vague. Écrivez ce qui s'ouvre, ce qui se voit et quelle commande réussit.",
        "acceptanceCheck": "L'acceptation doit être vérifiable.",
        "device": "Matrice d'appareils incomplète : {{missing}}",
        "paths": "Les chemins critiques sont requis.",
        "exceptions": "Exceptions incomplètes : {{missing}}",
        "exceptionsCode": "Les exceptions doivent citer un code d'erreur ou un statut HTTP si un contrat d'API est déclaré.",
        "api": "Le contrat d'API est requis, ou indiquez qu'il n'y a pas d'API HTTP.",
        "env": "Environnement incomplet : {{missing}}",
        "data": "Précontrôle incomplet : {{missing}}",
      ...
      "gap": {
        ...
        "evidence": "capture ou preuve cloud",
        "fallback": "un repli",
        "empty": "vide",
        "failure": "échec",
        ...
        "cors": "CORS",
        "auth": "auth",
        "thirdParty": "tiers joignables",
        "probeFailed": "une sonde en échec",
        "probePass": "un résultat réussi",
        "mapping": "correspondance des champs",
        "failureList": "liste d'échecs d'import",
        "exportable": "un export",
        "blocker": "un blocage",
        "sla": "SLA",
        "mock": "un mock",
        "parallel": "un chemin parallèle",
        "lcp": "LCP",
        "inp": "INP",
        "bundle": "taille du paquet",
        "longList": "longues listes virtualisées",
        "weakNet": "réseau lent",
        "largeData": "un essai à gros volume"
      },
      "stage": {
        "drafting": "Brouillon",
    ...
    "architecture": {
      ...
      "mountEmpty": "The architecture diagram appears here. Design it in chat, or regenerate.",
      "open": "Concevoir l'architecture",
      "needModules": "Confirmez chaque module avant de concevoir l'architecture.",
      "hint": "Les modules confirmés deviennent des blocs. Ensuite vient la répartition.",
      "summary": "Résumé",
      "summaryPh": "Comment les modules confirmés s'assemblent",
      "components": "Composants",
      "add": "Ajouter un composant",
      "name": "Nom",
      "responsibility": "Responsabilité",
      "confirm": "Confirmer l'architecture",
      "confirmed": "Architecture confirmée",
      "locked": "L'architecture est verrouillée. La répartition vient ensuite.",
      "needFields": "Un résumé et un composant nommé sont requis.",
      "enterDesign": "Requirements are confirmed. Next, design the system architecture in chat — pick an option or reply.",
      "kickoffPrompt": "Requirements are confirmed. Design the system architecture from the confirm cards: ask one key architecture question, put an Archify IR (diagram_type architecture, components with type/label, connections) plus summary in JSON, and give 2–5 short options. Do not dispatch.",
      "enterDesignExisting": "Les fonctions actuelles sont confirmées. Ensuite, décrivez l'architecture actuelle dans le chat — choisissez une option ou répondez.",
      "kickoffPromptExisting": "Les fonctions actuelles sont confirmées. Décrivez l'architecture actuelle à partir des cartes : une question clé, un IR Archify en JSON (diagram_type architecture, components avec type/label, connections) plus un summary des composants déjà présents, et 2 à 5 options courtes. Ne pas répartir.",
    ...
    "dispatch": {
      "open": "Répartition",
      "needArchitecture": "Confirmez l'architecture avant la répartition.",
      "workers": "Employés numériques",
      "recommend": "Recommandé : {{n}} (largeur parallèle)",
      "start": "Lancer les tâches",
      "roleImplement": "Réaliser",
      "roleVerify": "Vérifier",
      "roleDeploy": "Livrer",
      "splitNote": "Architecture confirmée. Découpage des tâches.",
      "splitting": "Découpage dans le chat. Le raisonnement est dans la conversation.",
      "decomposeTitle": "Découpage",
      "redecompose": "Redécouper",
      "parallel": "Parallèle",
      "workerSerial": "Série",
      "workerParallel": "Parallèle",
      "host": "Hébergement",
      "hostNone": "Ne pas publier",
      "hostPages": "GitHub Pages",
      "confirmGraph": "Confirmer l'effectif et dessiner le graphe",
      "graphBuilding": "Graphe en cours…",
      "graphReady": "Graphe prêt",
      "graphTitle": "Chemin d'exécution",
      "graphFail": "Graphe non généré : {{msg}}",
      ...
      "workerLane": "Employé {{id}}",
      "hint": "Le découpage est dans le chat. Après lecture de la liste et signature, confier aux sous-agents."
    },
    "baseline": {
      "mark": "Référence périmètre + recette (FDE-01)",
      "hint": "Sans signature, le démarrage reste fermé. Un changement exige un motif et une nouvelle signature.",
      "signer": "Signataire",
      "signerPh": "Nom ou rôle",
      "sign": "Signer la référence",
      "change": "Ouvrir un changement",
      "changeReason": "Motif du changement",
      "changePh": "Pourquoi le périmètre ou la recette change",
      "needSign": "Signez la référence avant la répartition.",
      "signedLine": "Signé · {{signer}} · {{at}}"
    },
    "pluginView": {
...
"importConfirm": "Les extensions importées s’exécutent dans le processus de l’agent avec les mêmes droits que ses outils. Les compétences déclarées peuvent ajouter des instructions à l’agent et les dépendances déclarées sont installées avec npm (scripts d’installation désactivés). Continuer ?",
    ...
    "permissionHelp": {
      ...
      "provider.register": "Ajoute les fournisseurs définis par ce plugin à la liste des fournisseurs des Paramètres. Le plugin fournit le point de terminaison et les modèles ; votre clé API reste dans DuaerAiDesk.",
      "desktop.control": "Permet d'appeler le catalogue DuaerAiDesk contrôlé ; les opérations destructrices exigent toujours confirm=true et le bearer token MCP n'est pas exposé.",
      ...
      "keyboard.globalShortcut": "Enregistre des raccourcis clavier système qui déclenchent les commandes propres à ce plugin lorsque DuaerAiDesk n'est pas au premier plan.",
  ...
  "extensions": {
    ...
    "subagents": {
      ...
      "presetCoderName": "Duaer Codeur",
      "presetCoderDesc": "Écrit le code d’une tâche assignée jusqu’à ce que l’acceptation tienne.",
      "presetUiDesignerName": "Designer UI",
      "presetUiDesignerDesc": "Écrit le style et la mise en page du site après l’architecture. Ne modifie pas les fichiers et ne découpe pas les tâches.",
      "presetJudgeName": "Duaer Arbitre",
      "presetJudgeDesc": "Juge une exigence, un périmètre, ou si l’acceptation est vérifiable.",
      "presetBlank": "Vierge",
      ...
      "judgmentModelHint": "Uniquement le modèle marqué pour le jugement.",
      "judgmentModelEmpty": "Pas encore de modèle de jugement. Marquez-en un.",
      ...
      "builtinModelNote": "Les instructions restent celles d'origine. Seul le modèle change.",
  ...
  "status": {
    ...
    "dbSchemaTooNew":
      "Cette version de DuaerAiDesk est plus ancienne que vos données locales (schéma de données {{found}}, cette version prend en charge {{supported}}). Installez la version plus récente de DuaerAiDesk qui a ouvert ces données en dernier, ou une version ultérieure.",
    "archMismatch":
