...
export const tr = {
  app: {
    ...
    starting: "DuaerAiDesk başlatılıyor…",
    loadingView: "Görünüm yükleniyor…",
    uiCrashed: "Arayüzde bir sorun oluştu",
  },
  startup: {
    slowTitle: "Hâlâ başlatılıyor…",
    slowBody: "DuaerAiDesk yerel servise ulaşmakta normalden uzun sürüyor. Kendiliğinden tamamlanabilir — bekleyebilir ya da önce günlükleri toplayabilirsiniz.",
    stalledTitle: "DuaerAiDesk başlatmayı tamamlayamadı",
  ...
  tray: {
    ...
    open: "DuaerAiDesk’u aç",
    quit: "DuaerAiDesk’tan çık",
    askTitle: "DuaerAiDesk arka planda çalışmaya devam etsin mi?",
    askBody:
      "Pencereyi kapattığınızda DuaerAiDesk sistem tepsisinde çalışmaya devam edebilir; hiçbir şey kaybolmaz. Bunu Ayarlar’dan dilediğiniz zaman değiştirebilirsiniz.",
    closeToTray: "Tepsiye kapat",
    confirmQuitTitle: "DuaerAiDesk'tan çıkılsın mı?",
    confirmQuitBody:
  ...
  chat: {
    ...
    placeholder: "DuaerAiDesk’tan herhangi bir konuda yardım isteyin",
    ...
    copy: "Kopyala",
    choiceOptions: "Önerilen yanıtlar",
    copied: "Kopyalandı",
  ...
  settings: {
    ...
    "judgmentModel": "Karar modeli",
    "judgmentModelUnset": "Yapılandırılmadı",
    "judgmentModelUnavailable": "Şu anda kullanılamıyor",
    ...
    "setJudgmentModel": "Karar modeli olarak ayarla",
    "judgmentModelSelected": "Seçili karar modeli",
...
sklm: {
    ...
    pluginProviderKeyHint: "DuaerAiDesk’ta saklanır ve çalışma zamanı tarafından kullanılır. Eklenti bu anahtarı asla almaz.",
    ...
    deploy: {
      title: "Dağıtım",
      pages: "GitHub Pages",
      pagesNote: "Anahtarlar yalnızca bu makinede kalır. Kayıttan sonra tekrar gösterilmez ve depoya yazılmaz. GitHub Pages oturum açmış gh kullanır.",
      cloudflare: "Cloudflare",
      cloudflareHint: "Token ve Account ID kaydedilince görevlendirmede Cloudflare seçilebilir.",
      token: "API Token",
      account: "Account ID",
      aliyun: "Alibaba Cloud",
      aliyunHint: "AccessKey ID ve Secret kaydedilince görevlendirmede Alibaba Cloud seçilebilir.",
      accessKeyId: "AccessKey ID",
      accessKeySecret: "AccessKey Secret",
      aws: "AWS",
      awsHint: "İki anahtar kaydedilince görevlendirmede AWS seçilebilir. Region isteğe bağlıdır.",
      ...
      configured: "Kayıtlı",
      missing: "Yok",
      keep: "Kayıtlı. Boş bırakılırsa korunur.",
      saved: "Kaydedildi",
  ...
  project: {
    ...
    createBackgroundLabel: "Arka plan",
    createBackgroundPlaceholder: "Bir iki cümle: kim için, hangi sorunu çözüyor…",
  ...
  scheduled: {
    description: "DuaerAiDesk açıkken yinelenen ajan görevlerini çalıştırın.",
    edit: "Görevi düzenle",
    ...
    localTimeHint: "Yerel saat dilimini kullanır. DuaerAiDesk açık kalmalıdır; kaçırılan çalıştırmalar atlanır.",
  ...
  panel: {
    ...
    tabs: {
      ...
      architecture: "Mimari",
      dispatch: "Görevlendirme",
    },
    requirements: {
      empty: "Gereksinim toplamak için kenar çubuğundan bir proje açın.",
      open: "Gereksinim topla",

      modules: "Modüller",
      addModule: "Modül ekle",
      progress: "Modüller {{done}}/{{total}} onaylandı",
      moduleName: "Modül adı",
      moduleDraft: "Taslak",
      moduleReady: "Hazır",
      baseline: "Temel çizgi",
      background: "Proje arka planı",
      backgroundPh: "Bu yinelemede ne yapılacak",
      global: "Genel gereksinimler",
      style: "Site stili",
      styleHint: "Mimari kilitlendikten sonra UI tasarımcısı yazar. Gereksinim onayı bunu denetlemez.",
      layout: "Yerleşim",
      layoutHint: "Mimari kilitlendikten sonra UI tasarımcısı yazar. Gereksinim onayı bunu denetlemez.",
      moduleBaseline: "Ortak temel çizgiler Genel gereksinimlerde denetlenir. Stil ve yerleşimi mimariden sonra UI tasarımcısı yazar. Buraya yazılan özgün gereksinim yine denetlenebilir olmalıdır.",
      lockHintNeedModule: "Bu modülün hedefini ve denetlenebilir kabulünü yazın. Yazılan özgün gereksinim de denetlenebilir olmalıdır.",
      lockHint: "Yerel kontroller geçene kadar onay kapalı kalır.",
      lockHintNeed: "Somut bir hedef, denetlenebilir bir kabul ve sekiz temel alanı doldurun.",
      lockHintReady: "İnceleme geçti. Bu modülü onaylayabilirsiniz.",
      lockHintChecking: "Bu modül denetleniyor…",
      lockHintFailed: "İnceleme geçmedi.",
      lockHintNeedValidate: "Gereksinim incelemesi bekleniyor.",
      autoHandle: "Otomatik düzelt",
      autoHandling: "Düzeltiliyor…",
      chatValidateStart: "Bu modülün onay kartı kontrol ediliyor…",
      chatValidatePassed: "İnceleme geçti: {{summary}}",
      chatValidateFailed: "İnceleme geçmedi: {{summary}}",
      chatNeedAutoHandle: "Onay kartı henüz eksik. Sohbette «Otomatik düzelt»i seçin veya iletişim kutusunda doldurmaya devam edin.",
      chatAutoHandleStart: "Onay kartı otomatik işleniyor (inceleme sorunlarından kontrol edilebilir kabul yazılıyor)…",
      chatValidateFixed: "Otomatik işlendi ve inceleme geçti: {{summary}}. Onaylayabilirsiniz.",
      chatFixStillFailed: "Otomatik düzeltmeden sonra hâlâ başarısız{{note}}. Yeniden deneyin veya kartı düzenleyin.",
      chatAutoFixFail: "Otomatik düzeltme başarısız: {{msg}}",
      chatAutoFixBusy: "Geçerli yanıt bitsin, sonra Otomatik düzelt’e yeniden basın.",
      lockHintModuleDone: "Bu modül onaylandı. Kalanlar için sekmeyi değiştirin.",
      lockHintLocked: "Tüm modüller onaylandı.",
      reqAdd: "Öğe ekle",
      reqRemove: "Bu öğeyi kaldır",
      allConfirmed: "Tüm modüller onaylandı",
      moduleLabel: "Modül {{n}}",
      goal: "Hedef",
      out: "Kapsam dışı",
      accept: "Kabul",
      acceptHint: "Doğrulanabilir sonuç: nerede açılır, ne görünür, hangi komut geçer.",
      assume: "Varsayımlar",
      placeholder: "Henüz onaylanmadı",
      confirm: "Confirm architecture — ready to dispatch",
      confirmed: "Onaylandı",
      locked: "Bu modül kilitli. Toplamaya devam etmek için modül ekleyin.",
      needFields: "Onaydan önce hedef ve kabul gerekli.",
      device: "Tarayıcılar ve cihazlar",
      deviceHint: "En az iki tarayıcı veya cihaz, kanıt ve yedek yol yazın.",
      devicePh: "Örnek: son iki Chrome sürümü, mobil Safari",
      paths: "Kritik yollar",
      pathsHint: "Entegrasyonun kapsaması gereken ana yollar.",
      pathsPh: "Örnek: giriş → ana sayfa → gönder",
      exceptions: "İstisnalar",
      exceptionsHint: "Boş, hata, izin, zaman aşımı ve yeniden denemeyi kapsayın.",
      exceptionsPh: "Örnek: boş liste; gönderim yeniden denenebilir; 403",
      apiContract: "API sözleşmesi",
      apiContractHint: "OpenAPI veya tip yolu. HTTP API yoksa bunu yazın.",
      apiContractPh: "Örnek: openapi/openapi.yaml veya HTTP API yok",
      envChecklist: "Ortam",
      envChecklistHint: "DNS, TLS, CORS, kimlik ve üçüncü taraflar başlamadan önce geçmeli.",
      envChecklistPh: "Örnek: DNS, TLS, CORS ve kimlik geçer",
      dataPrecheck: "Veri ön kontrolü",
      dataPrecheckHint: "Alan eşlemesi ve içe aktarma hata listesi. İçe aktarma yoksa bunu yazın.",
      dataPrecheckPh: "Örnek: mapping.csv veya içe aktarma yok",
      externalDeps: "Dış bağımlılıklar",
      externalDepsHint: "Engeller, SLA, bir mock ve paralel yol. Yoksa bunu yazın.",
      externalDepsPh: "Örnek: sağlayıcı API'si veya dış bağımlılık yok",
      perfBudget: "Performans bütçesi",
      perfBudgetHint: "LCP, INP, paket, uzun listeler ve yavaş ağ. Sayfa yoksa bunu yazın.",
      perfBudgetPh: "Örnek: LCP 2,5s veya sayfa performans gereksinimi yok",
      issue: {
        goalShort: "Hedef çok kısa.",
        acceptanceShort: "Kabul çok kısa.",
        acceptanceVague: "Kabul çok belirsiz. Neyin açıldığını, neyin göründüğünü ve hangi komutun geçtiğini yazın.",
        acceptanceCheck: "Kabul nesnel olarak doğrulanabilir olmalı.",
        device: "Cihaz matrisi eksik: {{missing}}",
        paths: "Kritik yollar gerekli.",
        exceptions: "İstisnalar eksik: {{missing}}",
        exceptionsCode: "API sözleşmesi varsa istisnalar bir hata kodu veya HTTP durumu içermeli.",
        api: "API sözleşmesi gerekli, ya da HTTP API olmadığını yazın.",
        env: "Ortam kontrolü eksik: {{missing}}",
        data: "Veri ön kontrolü eksik: {{missing}}",
        deps: "Dış bağımlılıklar eksik: {{missing}}",
      ...
      gap: {
        ...
        evidence: "ekran görüntüsü veya bulut kanıtı",
        fallback: "bir yedek yol",
        empty: "boş",
        failure: "hata",
        permission: "izin yok",
        timeout: "zaman aşımı",
        ...
        cors: "CORS",
        auth: "kimlik",
        thirdParty: "üçüncü taraf erişimi",
        probeFailed: "başarısız bir denetim",
        probePass: "geçen bir sonuç",
        mapping: "alan eşlemesi",
        failureList: "içe aktarma hata listesi",
        exportable: "bir dışa aktarma",
        blocker: "bir engel",
        sla: "SLA",
        mock: "bir mock",
        parallel: "paralel bir yol",
        lcp: "LCP",
        inp: "INP",
        bundle: "paket boyutu",
        longList: "sanallaştırılmış uzun listeler",
        weakNet: "zayıf ağ",
        largeData: "büyük veri denemesi",
      },
      stage: {
        drafting: "Taslak",
        ...
        building: "Geliştirme",
        delivered: "Teslim",
        revising: "İyileştirme",
      },
    },
    architecture: {
      title: "System architecture",
      mountEmpty: "The architecture diagram appears here. Design it in chat, or regenerate.",
      open: "Mimariyi tasarla",
      needModules: "Mimariyi tasarlamadan önce her modülü onaylayın.",
      hint: "Onaylanan modüller kutuya dönüşür. Mimari onayından sonra atama gelir.",
      summary: "Özet",
      summaryPh: "Onaylanan modüller nasıl bir araya gelir",
      components: "Bileşenler",
      add: "Bileşen ekle",
      name: "Ad",
      responsibility: "Sorumluluk",
      confirm: "Mimariyi onayla",
      confirmed: "Mimari onaylandı",
      locked: "Mimari kilitli. Sırada atama var.",
      needFields: "Bir özet ve adlı bir bileşen gerekli.",
      ...
      enterDesignExisting: "Mevcut işlevler onaylandı. Şimdi sohbette güncel sistem mimarisini çıkarın — bir seçenek seçin veya yanıtlayın.",
      kickoffPromptExisting: "Mevcut işlevler onaylandı. Onay kartlarından güncel sistem mimarisini çıkarın: bir mimari soru, JSON içinde Archify IR (diagram_type architecture, type/label içeren components, connections) ve bugün var olan bileşenlerin summary'si, 2–5 kısa seçenek. Görevlendirme yapmayın.",
    ...
    dispatch: {
      open: "Görevlendirme",
      needArchitecture: "Görevlendirmeden önce mimariyi onaylayın.",
      workers: "Dijital çalışanlar",
      recommend: "Önerilen: {{n}} (paralel genişlik)",
      start: "Görevleri başlat",
      roleImplement: "Uygula",
      roleVerify: "Doğrula",
      roleDeploy: "Teslim",
      ...
      workerLane: "Çalışan {{id}}",
      hint: "DuaerAiDesk hazır görevleri Task alt ajanlarıyla çalıştırır. Birden fazla çalışanda son şerit doğrulama ve teslimi yapar.",
    },
    baseline: {
      mark: "Kapsam + kabul temeli (FDE-01)",
      hint: "İmza olmadan başlatma kapalıdır. Kapsam veya kabul değişirse neden yazılır ve yeniden imzalanır.",
      signer: "İmzalayan",
      signerPh: "Ad veya rol",
      sign: "Temeli imzala",
      change: "Değişiklik aç",
      changeReason: "Değişiklik nedeni",
      changePh: "Kapsam veya kabul neden değişiyor",
      needSign: "Görevlendirmeden önce kapsam ve kabul temelini imzalayın.",
      signedLine: "İmzalandı · {{signer}} · {{at}}",
    },
    pluginView: {
...
importConfirm: "İçe aktarılan uzantılar ajan sürecinde, ajanın kendi araçlarıyla aynı erişimle çalışır. Bildirilen beceriler ajana talimatlar ekleyebilir ve bildirilen bağımlılıklar npm ile yüklenir (yükleme betikleri devre dışı). Devam edilsin mi?",
    ...
    permissionHelp: {
      ...
      "provider.register":
        "Bu eklentinin tanımladığı servisleri Ayarlar’daki servis listesine ekler. Uç noktayı ve modelleri eklenti sağlar; API anahtarınız DuaerAiDesk’ta kalır.",
      "desktop.control":
        "Eklentinin incelenmiş DuaerAiDesk denetim kataloğunu çağırmasını sağlar. Yıkıcı işlemler yine confirm=true gerektirir; MCP bearer token eklentiye verilmez.",
      ...
      "keyboard.globalShortcut": "DuaerAiDesk odakta değilken bu eklentinin kendi komutlarını tetikleyen sistem geneli klavye kısayollarını kaydeder.",
  ...
  extensions: {
    ...
    subagents: {
      ...
      presetCoderName: "Duaer Kodcu",
      presetCoderDesc: "Atanan görevin kabul ölçütü tutana kadar kodu yazar.",
      presetUiDesignerName: "UI tasarımcısı",
      presetUiDesignerDesc: "Mimari kilitlendikten sonra site stili ve yerleşimini yazar. Dosya düzenlemez, görev bölmez.",
      presetJudgeName: "Duaer Hakem",
      presetJudgeDesc: "Gereksinim, kapsam veya kabulün yeterince net olup olmadığına karar verir.",
      ...
      judgmentModelHint: "Yalnızca karar modeli olarak işaretlenen model.",
      judgmentModelEmpty: "Henüz karar modeli yok. Birini karar modeli olarak işaretleyin.",
      ...
      builtinModelNote: "Yönergeler yerleşik haliyle kalır. Burada yalnızca model değişir.",
      sourceProject: "Proje",
      name: "Ad",
  ...
  status: {
    ...
    dbSchemaTooNew:
      "Bu DuaerAiDesk sürümü yerel verilerinizden daha eski (veri şeması {{found}}, bu sürüm {{supported}} destekliyor). Bu verileri en son açan daha yeni DuaerAiDesk sürümünü veya sonrasını yükleyin.",
    archMismatch:
