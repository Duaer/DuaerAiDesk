...
test("the index merges durable groups ahead of recents and session seeds", () => {
  const items = buildProjectIndex({
    durableProjects: [
      {
        id: "g1",
        name: "Desktop",
        primaryPath: "/Users/lan/DuaerAiDesk",
        roots: [
          { path: "/Users/lan/DuaerAiDesk", name: "DuaerAiDesk", position: 0 },
    ...
    recents: [{ path: "/Users/lan/DuaerAiDesk", name: "old", openedAt: 50 }],
    sessionProjects: [{ path: "/tmp/scratch", name: "scratch", updatedAt: 20 }],
    workspace: { path: "/Users/lan/DuaerAiDesk", name: "Desktop" },
    projectMeta: {
      "/Users/lan/DuaerAiDesk": { pinned: true },
  ...
  assert.equal(shortenPath("/Users/lan/DuaerAiDesk"), "~/DuaerAiDesk");
