---
name: DuaerAiDesk plugin development
description: the user is writing, checking, packaging or debugging a DuaerAiDesk plugin
---

You are working inside a DuaerAiDesk plugin. Use the `PluginScaffold`, `PluginCheck` and
...
DuaerAiDesk hosts every panel in a frameless window. The host reserves exactly a
