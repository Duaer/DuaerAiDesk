...
import { RacpError, type Principal, type SessionSummary } from "@duaer-ai-desk/agent-host";
import {
...
import type { RacpHostOperations, RacpProjectCatalog, RacpSessionCatalog, RacpWorkspaceAccess } from "@duaer-ai-desk/racp";
import type { RacpProjectSummary } from "@duaer-ai-desk/shared";
...
export type HostOperationsDeps = {
  ...
  /** `duaer-ai-desk-host` boots the sidecar's session cleanup on delete; the runtime link is optional at boot. */
