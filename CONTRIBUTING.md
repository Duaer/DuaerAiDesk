# Contributing to DuaerAiDesk

Thanks for helping improve DuaerAiDesk. This guide applies to human and AI
contributors working on the repository.

DuaerAiDesk is released software with real users. Prefer small, reviewable
...
git worktree add -b <type>/<short-description> \
  ../DuaerAiDesk-worktrees/<short-description> origin/main
cd ../DuaerAiDesk-worktrees/<short-description>
```
...
git worktree remove ../DuaerAiDesk-worktrees/<short-description>
